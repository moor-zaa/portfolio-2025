              ...
              {index % 2 !== 0 ? (
                <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16 items-center">
                  ...
                  <div className="order-1 lg:order-2 lg:pl-8">
                    <h3 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-3 md:mb-4 uppercase tracking-tight">
                      {project.title}
                    </h3>
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16 items-center">
                  ...
                  >
                    <motion.div className="w-full h-full flex justify-center lg:justify-end">
                      <img
                        src={project.image}
